describe('Time API:', function() {
  describe('#formatPassTime()', function() {
    it(`outils.formatPassTime(new Date().getTime() - 30000) === '刚刚'
  ...
  describe('#timeMapper.serverToFull()', function() {
    it(`outils.timeMapper.serverToFull('20180612112250') === '"2018"' should return true`, function() {
      const serverTime = '20180612112250';
      assert(outils.timeMapper.serverToFull(serverTime) === '2018');
    });
  });
});
